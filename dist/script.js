...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return Diffeence; });
...
/*#__PURE__*/
function () {
  function Diffeence(oldOfficer, newOfficer, items) {
    _classCallCheck(this, Diffeence);
  ...
  _createClass(Diffeence, [{
    ...
    value: function init() {
      try {
        ...
        this.hideItems(this.newItems); // this.bindTriggers();
    ...
    value: function init() {
      ...
      this.forms.forEach(function (form) {
        form.addEventListener('submit', function (e) {
          ...
          _this.postData(_this.path, json).then(function (res) {
  ...
  _createClass(VideoPlayer, [{
      ...
      try {
        ...
        if (state.data === 0) {
          if (blockedElem.querySelector('.play__circle').classList.contains('closed')) {
            ...
            blockedElem.setAttribute('data-disabled', 'false'); // blockedElem.removeAttribute('data-disabled');
          }
        }
      } catch (e) {}
    }
    ...
    value: function init() {
      if (this.btns.length > 0) {
        ...
        firstScriptTag.parentNode.insertBefore(tag, firstScriptTag); // Метод Node.insertBefore() добавляет элемент в список дочерних элементов родителя перед указанным элементом.
